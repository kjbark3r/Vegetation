...
wd_jesse <- "F:\\NSERP_DeVoe\\Sapphire Elk\\Data\\ElkForageDiet\\ForagePlantAnalysis\\foragequality_DE"
...
#Connect to Access vegetation and forage plant databases
    if(file.exists(wd_jesse)) {
      channel <- odbcDriverConnect("Driver={Microsoft Access Driver (*.mdb, *.accdb)};
                                   dbq=F:/NSERP_DeVoe/Sapphire Elk/Data/ElkForageDiet/VegetationDatabase/SapphireElkProject_VegetationDatabase.accdb")
      channel.DMD <- odbcDriverConnect("Driver={Microsoft Access Driver (*.mdb, *.accdb)};
                                 dbq=F:/NSERP_DeVoe/Sapphire Elk/Data/ElkForageDiet/ForagePlantAnalysis/ForagePlantDatabase.accdb")
      channel.sbroot <- odbcDriverConnect("Driver={Microsoft Access Driver (*.mdb, *.accdb)};
                                 dbq=F:/NSERP_DeVoe/Sapphire Elk/Data/ElkForageDiet/VegetationDatabase/sbrootdata/SBrootVegData.accdb")
      } else {
      if(file.exists(wd_kelly)) {
        channel <- odbcDriverConnect("Driver={Microsoft Access Driver (*.mdb, *.accdb)};
                                     dbq=F:/SapphireVegModels/DataCode/SapphireElkProject_VegetationDatabase.accdb")
        channel.DMD <- odbcDriverConnect("Driver={Microsoft Access Driver (*.mdb, *.accdb)};
                                 dbq=........................................................../ForagePlantDatabase.accdb")
        channel.sbroot <- odbcDriverConnect("Driver={Microsoft Access Driver (*.mdb, *.accdb)};
                                            dbq=.............................................../SBrootVegData.accdb")
      } else {
        cat("Are you SURE you got that file path right?\n")
      }
          }
rm(wd_jesse, wd_kelly)
...
length(unique(forage.quadrat$PlotVisit)) # 655 total plots w/ summer forage; 613 plots w/ winter forage
...
#write.csv(dm.phenospp.quadrat, "sapp_phenology_byforagessp_perquadrat.csv")
